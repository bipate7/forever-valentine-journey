...
import { ArrowLeft, Lock, Calendar, Heart, Handshake } from "lucide-react";
...
export default function PromiseDay() {
  ...
  useEffect(() => {
    // Calculate time until February 11 (Promise Day)
    const targetDate = new Date();
    targetDate.setMonth(1, 11); // February 11
      ...
      <div className="max-w-2xl w-full">
        ...
        >
          ...
          <motion.div
            ...
            className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-blue-400 to-purple-400 rounded-full flex items-center justify-center shadow-xl"
          >
          ...
          <p className="text-lg text-white/80 mb-8" style={{ fontFamily: 'var(--font-quicksand)' }}>
            A special promise is being prepared for you, my love. 
            This day will mark our commitment to each other and our future together!
          </p>

          {/* Countdown */}
          <div className="bg-black/30 rounded-2xl p-6 mb-8">
            <h3 className="text-xl font-bold text-blue-400 mb-4">Unlock In:</h3>
          ...
          <Link href="/">
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-all"
            >
